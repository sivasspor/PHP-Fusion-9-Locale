...
$locale['setup_0053'] = "Поддежка OPCache";
...
$locale['setup_0110'] = "Из-за настроек для токена сервера в файле httpd.confg невозможно определть версию Apache без mod_rewrite, минимально необходиимая версия &ndash; 2.2.16.";
...
$locale['setup_0113'] = "Ваша установленая копия PHP слишком старая. PHP-Fusion требует как минимум версии 5.5.21. Версии PHP выше 5.6.5 или 5.5.21 обеспечивают встроенную защиту от SQL-инъекций для баз данных MySQL. Рекомендуем Вам обновить свою версию.";
...
$locale['setup_1209'] = "Пожалуйста, подождите, пока PHP-Fusion 9 будет установлена на Ваш сервер.";
...
$locale['setup_1212'] = "Параметры сайта и Суперадминситратора";
...
$locale['setup_1312'] = "Этот префикс таблиц уже используется.";
...
$locale['setup_1511'] = "Часовой пояс сайта:";
