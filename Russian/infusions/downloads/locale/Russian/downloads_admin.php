...
$locale['download_0044'] = "Для добавления загрузки используйте форму ниже. Ваша загрузка будет рассмотрена администратором сайта [SITENAME], оставляющим за собой право изменить или удалить любой присланный материал. Загрузка должна соответствовать ощей тематике сайта. Неподхожящие загрузки могутбудут удалены.";
