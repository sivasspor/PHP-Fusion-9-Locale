 ...
 */
$locale['uf_msn'] = "MSN";
$locale['uf_msn_id'] = "Ім&lsquo;я користувача MSN";
$locale['uf_msn_desc'] = "Обліковий запис в Microsoft Messenger";
$locale['uf_msn_error'] = "Поле імені користувача MSN не може бути порожнім";